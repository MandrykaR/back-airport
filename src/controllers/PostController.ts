...
export class PostController {
    ...
    static async createPost(req: Request<{}, {}, CreateUpdatePostDTO>, res: Response<ApiResponse<Post>>) {
        try {
    ...
    static async updatePost(req: Request<{ id: string }, {}, CreateUpdatePostDTO>, res: Response<ApiResponse<Post>>) {
        try {
            const postRepository = AppDataSource.getRepository(Post);
            await postRepository.update(req.params.id, req.body);

            const updatedPost = await postRepository.findOne({ where: { id: req.params.id } });
    ...
    static async deletePost(req: Request<{ id: string }>, res: Response<ApiResponse<{ message: string }>>) {
        try {
            const postRepository = AppDataSource.getRepository(Post);
